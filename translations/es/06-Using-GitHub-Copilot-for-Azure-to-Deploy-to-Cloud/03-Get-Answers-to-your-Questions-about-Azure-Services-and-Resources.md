...
- "@azure ¿Qué tipos de aplicaciones en contenedores admite Azure?"  
...
- "@azure ¿Por qué elegiría Azure Container Apps sobre AKS?"  

### Aprende cómo usar los servicios de Azure para tu aplicación

|Servicio o tecnología|Ejemplos de solicitudes para aprender|
|---|---|
|Azure AI Search|<ul><li>"@azure ¿Qué es Azure AI Search y por qué debería usarlo?"</li><li>"@azure ¿Cómo funciona el precio de Azure AI Search?"</li><li>"@azure ¿Cómo se integra Azure AI Search con Azure OpenAI?"</li><li>"@azure ¿Cómo se integra Azure AI Search con Azure Machine Learning?"</li><li>"@azure ¿Cuándo debo usar búsqueda híbrida o búsqueda vectorial en lugar de un clasificador semántico en Azure AI Search?"</li><li>"@azure ¿Es Azure AI Search una base de datos vectorial? ¿Cómo asegura Azure AI Search la precisión y relevancia de los resultados de búsqueda vectorial?"</li><li>"@azure ¿Qué soporte tienes para aplicaciones multi-inquilino de alta escala en Azure AI Search?"</li><li>"@azure ¿Qué es la función de vectorización integrada en Azure AI Search? ¿De qué fuentes de datos puedo extraer datos y usar la vectorización integrada?"</li><li>"@azure ¿Qué es el enriquecimiento de IA en Azure AI Search? ¿Cómo funciona el enriquecimiento de IA? ¿Cuáles son los beneficios de usarlo?"</li><li>"@azure ¿Qué es el clasificador semántico en Azure AI Search? ¿Cómo es diferente de la búsqueda vectorial?"</li><li>"@azure ¿Cuáles son los ejemplos de código o aceleradores de soluciones más recomendados para Azure AI Search?"</li><li>"@azure ¿Cuáles son algunos ejemplos reales de empresas que usan Azure AI Search?"</li></ul>|
|Azure API Management|<ul><li>"@azure ¿Cuáles son los beneficios y aplicaciones de Azure API Management?"</li></ul>|
|Azure App Service|<ul><li>"@azure ¿Cómo despliego una aplicación web en Azure?"</li><li>"@azure ¿Cómo creo una aplicación de App Service y despliego código en un entorno de pruebas usando la CLI?"</li><li>"@azure Crea un script para desplegar una aplicación web que se ejecutará en C#."</li><li>"@azure ¿Qué opciones de base de datos tiene Azure para aplicaciones web?"</li><li>"@azure ¿Qué opciones serverless tiene Azure para aplicaciones web?"</li><li>"@azure Crea una guía para maximizar Azure App Service."</li></ul>|
...
|Azure Container Apps|<ul><li>"@azure ¿Qué es el servicio Azure Container Apps?"</li><li>"@azure Explícame la diferencia entre una aplicación de contenedor y un entorno de aplicaciones de contenedor."</li></ul>|
|Azure Cosmos DB|<ul><li>"@azure ¿Por qué usaría Azure Cosmos DB en lugar de Azure SQL?"</li><li>"@azure Quiero usar Azure Cosmos DB para almacenar mis datos."</li><li>"@azure ¿Por qué usaría una cuenta de Azure Cosmos DB en lugar de una base de datos SQL?"</li></ul>|
|Azure Data Factory|<ul><li>"@azure ¿Cómo creo canalizaciones de datos con Azure Data Factory?"</li></ul>|
|Azure Developer CLI (`azd`)|<ul><li>"@azure ¿Tienes modelos de despliegue de ejemplo para Azure? SaaS, PaaS, etc."</li><li>"@azure ¿Cuál es la mejor infraestructura para mi aplicación?"</li><li>"@azure ¿Cómo configuro mi entorno de Azure?"</li><li>"@azure ¿Qué son las plantillas de Azure Resource Manager y cómo las uso?"</li><li>"@azure ¿Cómo gestiono entornos con la CLI para desarrolladores de Azure?"</li><li>"@azure ¿Qué es la CLI para desarrolladores de Azure?"</li><li>"@azure ¿Cuál es la diferencia entre Bicep y las plantillas ARM?"</li><li>"@azure ¿Cómo me aseguro de que mis entornos tengan los mejores patrones de seguridad?"</li><li>"@azure ¿Cómo despliego usando mi pipeline CI/CD?"</li></ul>|
...
|Azure Key Vault|<ul><li>"@azure Explica cómo y por qué debería usar Azure Key Vault."</li></ul>|
|Azure Kubernetes Service (AKS)|<ul><li>"@azure ¿Cómo obtengo el estado de todos los nodos en mi clúster de AKS?"</li><li>"@azure ¿Cuál es el comando para configurar un contexto para mi clúster de AKS?"</li></ul>|
...
|Azure Virtual Network|<ul><li>"@azure ¿Cómo balanceo el tráfico de red entrante hacia mi aplicación?"</li></ul>|
|Azure OpenAI Service|<ul><li>"@azure ¿Qué servicios proporciona Azure OpenAI?"</li><li>"@azure ¿Dónde está disponible GPT-4o mini?"</li><li>"@azure ¿Cuáles son los requisitos previos para integrar Azure OpenAI?"</li><li>"@azure Crea una guía para crear y usar recursos de Azure OpenAI."</li><li>"@azure ¿Cuáles son los tipos disponibles de modelos de Azure OpenAI?"</li></ul>|
|Azure SDK|<ul><li>"@azure ¿Puedo usar Azure SDKs en el navegador?"</li><li>"@azure ¿El SDK de almacenamiento en C# admite cargas y descargas fragmentadas de blobs?"</li></ul>|
