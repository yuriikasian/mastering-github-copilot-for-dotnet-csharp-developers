![Maîtriser GitHub Copilot pour les développeurs .NET / C#](../../images/GitHub%20101%20-%20Curriculum%20dotnet.png)

# Maîtriser GitHub Copilot pour les développeurs C#/.NET
Améliorez votre efficacité en codage avec notre cours en 6 leçons animé par des experts, conçu pour les développeurs C#/.NET. Apprenez à intégrer facilement l'assistance au codage alimentée par l'IA dans votre flux de travail, à automatiser les tests et à renforcer la collaboration d'équipe en utilisant Visual Studio Code et Copilot Chat. De l'autocomplétion intelligente aux tests unitaires simplifiés, ce cours couvre des techniques essentielles pour vous aider à écrire un code plus propre, plus rapide et plus intelligent.
...
Vous trouverez ci-dessous des liens vers chaque leçon—n'hésitez pas à explorer et à plonger dans les sujets qui vous intéressent le plus !

## 🌐 Apprenez dans votre propre langue
...
Après avoir terminé ce cours, consultez notre [Collection GitHub Copilot Learn](https://learn.microsoft.com/collections/kkqrhmxoqn54) pour continuer à développer vos connaissances en programmation assistée par l'IA !

## 🚀 Vous êtes une startup ou avez une idée à lancer ? 
...
- Trouvez des erreurs orthographiques ou des erreurs de code, [soumettez un problème](https://github.com/microsoft/) ou [créez une pull request](https://github.com/microsoft/).
- Envoyez-nous vos idées, que ce soit pour de nouvelles leçons ou des exercices, et dites-nous comment nous pouvons nous améliorer.
...
| :---: | :------------------------------------------: | :-----------------------------------------------------------: | ----------------------------------------------------------- |
| 01 | [Introduction à GitHub](./01-Introduction-to-GitHub/README.md) | Découvrez comment utiliser GitHub en moins d'une heure. | Introduction aux dépôts, branches, commits et pull requests.                    |
| 02 | [Introduction à GitHub Codespaces](./02-Introduction-to-GitHub-Codespaces/README.md) | Développez du code en utilisant GitHub Codespaces et Visual Studio Code ! | Comment créer un codespace, pousser du code depuis un codespace, sélectionner une image personnalisée et personnaliser un codespace. | 
| 03 | [Introduction à GitHub Copilot](./03-Introduction-to-GitHub-Copilot/README.md) | GitHub Copilot peut vous aider à coder en proposant des suggestions de type autocomplétion directement dans VS Code et Codespaces. | Créer des fichiers avec du code généré par Copilot AI pour des suggestions de code et de commentaires. | 
| 04 | [Utiliser GitHub Copilot avec C#](./04-Using-GitHub-Copilot-with-CSharp/README.md) | Utilisez GitHub Copilot, un assistant de programmation IA qui propose des suggestions de type autocomplétion pendant que vous codez, pour travailler avec C#. | Activer l'extension GitHub Copilot dans Visual Studio Code. Rédiger des invites pour générer des suggestions utiles avec GitHub Copilot. Utiliser GitHub Copilot pour améliorer un projet API minimal en C#. |
| 05 | [Créer un mini-jeu avec GitHub Copilot](./05-Creating-Mini-Game-with-GitHub-Copilot/README.md) | Utilisez GitHub Copilot pour vous aider à construire un mini-jeu basé sur C#. | Rédiger des invites qui peuvent générer des suggestions utiles avec GitHub Copilot pour intégrer la logique de jeu et améliorer votre jeu basé sur C#. |
| 06 | [Commencer avec Copilot pour Azure pour un déploiement dans le cloud](./06-Using-GitHub-Copilot-for-Azure-to-Deploy-to-Cloud/README.md) | Apprenez le déploiement dans le cloud avec GitHub Copilot pour Azure—votre guide ultime pour un succès simplifié dans le cloud. | Déploiement d'applications sans effort en tirant parti de la puissante évolutivité d'Azure. |

## 🎒  Autres cours 

Découvrez d'autres cours .NET sur Microsoft Learn Training :

* [Apprendre C#](https://learn.microsoft.com/training/paths/get-started-c-sharp-part-1/)
...
* [Développer des applications d'IA générative avec Azure OpenAI](https://learn.microsoft.com/training/paths/develop-ai-agents-azure-open-ai-semantic-kernel-sdk/)
* [Créer des applications distribuées avec .NET Aspire](https://learn.microsoft.com/training/paths/dotnet-aspire/)

### 📽️ Série de vidéos pour débutants :
...
Lorsque vous soumettez une pull request, un bot CLA déterminera automatiquement si vous devez fournir un CLA et annotera  
la PR en conséquence (par exemple, vérification de statut, commentaire). Suivez simplement les instructions fournies par le bot.  
Vous n'aurez besoin de le faire qu'une seule fois pour tous les dépôts utilisant notre CLA.  
...
Ce projet peut contenir des marques déposées ou des logos pour des projets, produits ou services. L'utilisation autorisée des  
marques déposées ou logos de Microsoft est soumise et doit respecter les  
...
L'utilisation des marques déposées ou logos de Microsoft dans des versions modifiées de ce projet ne doit pas prêter à confusion ni  
sous-entendre un parrainage de Microsoft. Toute utilisation de marques déposées ou logos de tiers est soumise aux politiques de ces tiers.  
